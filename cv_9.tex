...
\par{\centering{\Huge \textsc{Michinari Sakai}}\bigskip\par} % Your name
...
\ce{^{130}Te}. I have also worked on thermal modeling of the detector
...
%My main interest has been in detector development and novel techniques to search
%for previously unexplored phase-space regions in neutrino physics. 
%My main interest and past research experience has been in detector development
...
background isotopes such as \ce{^{8}He} and \ce{^{9}Li}. These backgrounds are
